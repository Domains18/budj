...
export default function EarnMoreScreen() {
  ...
  const connectSocialMedia = () => {
    Haptics.impactAsync(Haptics.ImpactFeedbackStyle.Light);
    Alert.alert('Connect Social Media', 'Social media integration coming soon!');
  };
        ...
        <View style={styles.content}>
          ...
          <View style={styles.referralCard}>
            ...
            <Text style={styles.referralDescription}>
              Share your code with friends and earn KES 500 when they make their first purchase!
            </Text>
          </View>
          ...
          <View style={styles.tipsCard}>
            ...
            <View style={styles.tip}>
              <Text style={styles.tipText}>• Shop at partner stores to maximize cashback</Text>
            </View>
            <View style={styles.tip}>
              <Text style={styles.tipText}>• Check for exclusive offers daily</Text>
            </View>
            <View style={styles.tip}>
              <Text style={styles.tipText}>• Invite friends during bonus periods</Text>
            </View>
            <View style={styles.tip}>
              <Text style={styles.tipText}>• Complete your profile for better rewards</Text>
            </View>
          </View>
        </View>
      </ScrollView>
